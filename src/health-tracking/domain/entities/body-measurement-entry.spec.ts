...
const measurement = (overrides: Partial<Parameters<typeof BodyMeasurementEntry.create>[0]> = {}) =>
...
describe('BodyMeasurementEntry', () => {
  ...
  it('validates positivity, length units and custom names', () => {
    ...
    expect(() => measurement({ customMeasurementName: 'unexpected' })).toThrow(
